...
export const courseSeed = [
  {
    ...
    faq: [
      { q: "É para iniciantes?", a: "Serve para quem já cria e para quem ainda está estruturando seu método." },
      { q: "Foca em qual ferramenta?", a: "O curso ensina pensamento de direção e fluxo adaptável a diferentes ferramentas." }
    ],
    featured: true
  },
  {
    ...
    faq: [
      { q: "É só para ficção?", a: "Não. Também serve para marca pessoal e projetos híbridos." }
    ],
    featured: false
  }
...
] satisfies Prisma.TestimonialCreateInput[];
