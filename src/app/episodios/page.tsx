...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: absoluteUrl("/episodios"),
    type: "website",
    locale: "pt_BR",
    images: [{ url: absoluteUrl("/og-default.png"), width: 1200, height: 630, alt: "A Bastilha de Bolsonier — Atos" }]
  },
  twitter: {
  ...
  alternates: { canonical: absoluteUrl("/episodios") }
};
